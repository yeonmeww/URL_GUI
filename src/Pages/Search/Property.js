...
const UserInformation = () => {
  // 폼에 표시할 필드 정의
  const infoFields = ['rst_id', 'mat_id', 'workorder_id', 'simulation_recipe_id','rst_properties','rst_date','contributor_id'];
  
  // 테이블에 표시할 헤더 정의
  const tableHeaders = ['rst_id', 'mat_id', 'workorder_id', 'simulation_recipe_id','rst_properties','rst_date','contributor_id'];
