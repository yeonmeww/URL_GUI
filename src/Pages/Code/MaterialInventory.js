...
const UserInformation = () => {
  // 폼에 표시할 필드 정의
  const infoFields = ['Material_ID', 'Material_Name', 'Chemical_formula', 'Data','Provider_ID','Provider_Name','Quantity'];
  
  // 테이블에 표시할 헤더 정의
  const tableHeaders = ['Material_ID', 'Material_Name', 'Chemical_formula', 'Data','Provider_ID','Provider_Name','Quantity'];
